...
//#pragma OPENCL EXTENSION cl_amd_printf : enable // TODO: edw. use method like addDefinition

#ifdef XILINX // FIXME: Xilinx, force not to use amd_bitalign
...
#ifdef XILINX // FIXME: Xilinx has no atomic_inc
        uint slot = 0;
        g_output->count = 1;
#else
